...
import { antennaSamples, applyAntennaSampleToCircuit, applyAntennaSampleToSettings } from "./antennaSamples";
...
export default function Settings({ settings, setSettings, setUserCircuit, usedF, chosenSparameter, chosenNoiseParameter }) {
  const { t } = useTranslation();
  ...
  function applyAntennaSample() {
    ...
    setSettings((current) => applyAntennaSampleToSettings(sample, current));
    setUserCircuit((current) => applyAntennaSampleToCircuit(sample, current));
  }
